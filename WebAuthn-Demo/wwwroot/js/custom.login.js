...
async function handleSignInSubmit(event) {
    ...
    let assertionOptionsApi = '/Auth/AssertionOpts';
    try {
        var res = await fetch(assertionOptionsApi, {
            method: 'POST', // or 'PUT'
...
async function verifyAssertionWithServer(assertedCredential) {
    console.log("Asserted credential: ", assertedCredential);
    ...
    let makeAssertionApi = '/Auth/MakeAssertion';
    let response;
    try {
        let res = await fetch(makeAssertionApi, {
            method: 'POST', // or 'PUT'
