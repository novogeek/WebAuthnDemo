...
async function fetchMakeCredentialOptions(formData) {
    let makeCredentialOptionsApi = '/Auth/MakeCredentialOptions';
    let response = await fetch(makeCredentialOptionsApi, {
        method: 'POST', // or 'PUT'
...
async function registerCredentialWithServer(formData) {
    let makeCredentialApi = '/Auth/MakeCredential';
    let response = await fetch(makeCredentialApi, {
        method: 'POST', // or 'PUT'
