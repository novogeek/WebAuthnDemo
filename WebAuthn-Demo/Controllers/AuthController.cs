...
namespace WebAuthn_Demo.Controllers
{
    public class AuthController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AssertionOpts([FromForm] string username, [FromForm] string userVerification)
        {
            try
            {
        ...
        private async Task SetClaimsPrincipalAsync(string userId) {
